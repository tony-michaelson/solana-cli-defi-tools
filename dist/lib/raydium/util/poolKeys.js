...
export async function fetchPoolKeys(connection, poolId, programId = LIQUIDITY_PROGRAM_ID_V4, serumProgramId = SERUM_PROGRAM_ID_V3, version = 4, serumVersion = 3, marketVersion = 3) {
    ...
    const { baseMint, quoteMint, lpMint, openOrders, targetOrders, baseVault, quoteVault, marketId, baseDecimal, quoteDecimal, } = fields;
