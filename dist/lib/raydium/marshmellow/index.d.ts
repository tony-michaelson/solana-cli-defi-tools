...
import { Blob, blob, Layout, Structure as _Structure, UInt, Union as _Union } from './buffer-layout.js';
export { blob };
...
export declare type GetLayoutSchemaFromStructure<T extends Structure<any, any, any>> = T extends Structure<any, any, infer S> ? S : any;
export declare type GetStructureFromLayoutSchema<S> = Structure<any, any, S>;
export declare class Union<Schema> extends _Union<Schema> {
