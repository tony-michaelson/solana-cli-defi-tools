...
import { bits, Blob, blob, Layout, offset as _offset, seq as _seq, Structure as _Structure, u32 as _u32, u8 as _u8, UInt, union as _union, Union as _Union, } from './buffer-layout.js';
export { blob };
            ...
            : new Proxy(count /* pretend to be Layout<number> */, {
                get(target, property) {
                    if (!parsedCount) {
                        ...
                        parsedCount = BN.isBN(countProperty)
